...
namespace Knapcode.KitchenSink.Extensions
{
    public static class HttpRequestMessageExtensions
    {
        ...
        /// <summary>
        /// Get the redirect history from a <see cref="HttpRequestMessage"/>.
        /// </summary>
        /// <param name="request">The request.</param>
        /// <returns>The history.</returns>
        public static IEnumerable<HttpResponseMessage> GetRedirectHistory(this HttpRequestMessage request)
        {
            return request.GetTryValue<HttpRequestMessage, IEnumerable<HttpResponseMessage>>(TryGetRedirectHistory);
        }
